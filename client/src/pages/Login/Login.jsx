...
const Login = () => {
    ...
    return (
        <>
            ...
            {/* =========================
                  OUTER WRAPPER — handles centering + scroll on all screens
            ========================= */}
            <Box
                sx={{
                    width: "100%",
            ...
            >
                <Fade in timeout={500}>
                    ...
                    >
                        {/* =====================================================
                    LEFT SIDE — visible from sm (600px) up, covers
                    iPad mini (768) / iPad Air (820) / iPad Pro (834+) in
                    portrait, as well as all landscape tablets and desktops.
                ===================================================== */}
                        <Box
                            sx={{
                                width: { sm: "45%", md: "48%", lg: "50%" },
                        ...
                        >
                            ...
                            <Box
                                sx={{
                                    position: "absolute",
                                    width: { sm: 160, md: 220, lg: 300 },
                                    height: { sm: 160, md: 220, lg: 300 },
                                    borderRadius: "50%",
                                    background: "rgba(255,255,255,0.07)",
                                    top: { sm: -70, md: -100, lg: -120 },
                                    right: { sm: -60, md: -80, lg: -90 },
                                }}
                            />
                            ...
                            <Box
                                sx={{
                                    position: "absolute",
                                    width: { sm: 130, md: 180, lg: 230 },
                                    height: { sm: 130, md: 180, lg: 230 },
                                    borderRadius: "50%",
                            ...
                            <Box sx={{ position: "relative", zIndex: 2 }}>
                                <Box
                                    sx={{
                                        ...
                                        borderRadius: 2.5,
                                        px: { sm: 1.2, md: 1.5, lg: 1.8 },
                                        py: { sm: 0.6, md: 0.75, lg: 0.9 },
                            ...
                            <Box sx={{ position: "relative", zIndex: 2, textAlign: "center", px: 2 }}>
                                <Box
                                    sx={{
                                        width: { sm: 85, md: 100, lg: 130 },
                                        height: { sm: 85, md: 100, lg: 130 },
                                        borderRadius: "50%",
                                        mx: "auto",
                                        mb: { sm: 1.5, md: 2, lg: 2.5 },
                                        display: "flex",
                                        alignItems: "center",
                                ...
                                >
                                    <SchoolOutlinedIcon sx={{ fontSize: { sm: 36, md: 48, lg: 66 } }} />

                                    <Box
                                        sx={{
                                            position: "absolute",
                                            right: { sm: -2, md: 0, lg: 4 },
                                            bottom: { sm: 2, md: 4, lg: 8 },
                                            width: { sm: 30, md: 34, lg: 42 },
                                            height: { sm: 30, md: 34, lg: 42 },
                                            borderRadius: "50%",
                                            display: "flex",
                                            alignItems: "center",
                                            justifyContent: "center",
                                ...
                                <Typography
                                    sx={{
                                        fontWeight: 800,
                                        fontSize: { sm: "1.05rem", md: "1.3rem", lg: "1.7rem" },
                                        mb: 1
                                    }}>
                                    Learn. Grow. Succeed.
                                </Typography>
                                ...
                                <Typography
                                    sx={{
                                        ...
                                        fontSize: { sm: "0.72rem", md: "0.8rem", lg: "0.92rem" },
                                        lineHeight: 1.65,
                                    }}
                                >
                                ...
                                {/* FEATURES */}
                                <Box sx={{ display: "flex", justifyContent: "center", gap: { sm: 1.5, md: 2.5, lg: 4 }, mt: { sm: 2, md: 2.5, lg: 3.5 }, flexWrap: "wrap" }}>
                                    {[
                ...
                ===================================================== */}
                        <Box
                            sx={{
                                width: { xs: "100%", sm: "55%", md: "52%", lg: "50%" },
                                minWidth: 0,
                                display: "flex",
                                flexDirection: "column",
                                justifyContent: "center",
                        ...
                        >
                            {/* MOBILE LOGO — only phones, since sm+ now has the left panel logo */}
                            <Box sx={{ display: { xs: "flex", sm: "none" }, justifyContent: "center", mb: 2 }}>
                                <Box
                                    component="img"
                                    src={logo}
                                    alt="LearnHub Logo"
                                    sx={{ width: 120, maxWidth: "50vw", height: "auto", display: "block" }}
                                />
                            </Box>
                            ...
                            <Box sx={{ width: "100%", maxWidth: 420, mx: "auto" }}>
                                <Typography
                                    sx={{
                                        ...
                                        fontSize: { xs: "1.3rem", sm: "1.4rem", md: "1.65rem" },
                                        lineHeight: 1.25,
                                        mb: 0.5
                                    }}>
                                    Welcome Back 👋
                                ...
                                <Box component="form" onSubmit={handleLogin} noValidate>
                                    ...
                                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 1, mb: 0.5, mt: 0.3, flexWrap: "wrap" }}>
                                        <Typography
                                            variant="body2"
                                            sx={{
                                                fontWeight: 600,
